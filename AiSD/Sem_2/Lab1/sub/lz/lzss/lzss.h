...
namespace lzss_ns {
    ...
    void lzss_1(std::istream& stream_in, std::ostream& stream_out, const uint8_t& num_byte, size_t buffer_size);
    void de_lzss_1(std::istream& stream_in, std::ostream& stream_out, const uint8_t& num_byte, size_t buffer_size);
